...
// Address: 0x730C28409303ceC9518C040105d8d63ac7328517
// Creation of MEtaverse Smart Cotnract with NFT Tokens
contract Metaverse is ERC721, Ownable {

    // Constructor
    constructor() ERC721("META", "JHC") {}
    ...
    function getOwnerBuldings() public view returns (Building[] memory) {
